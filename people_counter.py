...
def people_counter():
	...
	mqtt_client_id = "Jy8HAwYQOR03CzUoCgQHKgc"
	mqtt_user = "Jy8HAwYQOR03CzUoCgQHKgc"
	mqtt_password = "SyvF7KYlbU9j6pJpkYyrj14j"
	mqtt_server = "mqtt3.thingspeak.com"
	mqtt_port = 1883
	mqtt_topic_in = "channels/2518377/publish/fields/field1"
	mqtt_topic_out = "channels/2518377/publish/fields/field2"
	mqtt_topic_total = "channels/2518377/publish/fields/field3"
	...
	while True:
		...
		client.loop_start()
		In = totalDown  # example temperature value
		out = totalUp
		TOTAL = total
		client.publish(mqtt_topic_in, payload=In, qos=1)
		client.publish(mqtt_topic_out, payload=out, qos=1)
		client.publish(mqtt_topic_total, payload=''.join(map(str, TOTAL)), qos=1)
		info_status = [
		("Exit", totalUp),
		("Enter", totalDown),
		("Status", status),
